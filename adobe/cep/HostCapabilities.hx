...
extern class HostCapabilities {
	...
	#else
	public function new(EXTENDED_PANEL_MENU:Bool, EXTENDED_PANEL_ICONS:Bool, DELEGATE_APE_ENGINE:Bool, SUPPORT_HTML_EXTENSIONS:Bool):Void;
	#end
